...
export default function AddCourse() {
  ...
  return (
    <div className=" max-w-4xl mx-auto rounded-lg bg-gray-900 px-6 lg:py-4 mt-20 lg:px-8 sm:py-4">
      <p className=" text-white font-medium text-lg py-5">Add courses</p>

      <form className="bg-gray-900 mx-auto mt-5 max-w-xl sm:mt-10">
