    ...
    <div className="container px-6 py-8 mx-auto">
        <div className="xl:items-center xl:-mx-8 xl:flex">
            <div className="flex flex-col items-center xl:items-start xl:mx-8">
                ...
                <a href="#" className="flex items-center mt-4 -mx-1 text-sm text-white capitalize dark:text-blue-400 hover:underline hover:text-blue-600 dark:hover:text-blue-500">
            ...
            <div className="flex-1 xl:mx-8">
                <div className="mt-8 space-y-8 md:-mx-4 md:flex md:items-center md:justify-center md:space-y-0 xl:mt-0">
                    <div className="max-w-sm mx-auto border rounded-lg md:mx-4 bg-gray-950 border-gray-950">
                        <div className="p-6">
                            <h1 className="text-xl font-medium  capitalize lg:text-2xl text-white">Essential</h1>
